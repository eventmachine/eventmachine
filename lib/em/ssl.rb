  ...
  module SSL
    ...
    module X509
      ...
      class StoreContext
        ...
        def initialize(certificate, error_depth, error, error_string, verify)
          require "openssl"
          @current_cert = OpenSSL::X509::Certificate.new(certificate)
          @error = error
        ...
        # @return [Boolean] if the certificate was verified in this context
        attr_reader :verify
