module EventMachine
  ...
  class Connection
    ...
    # @see #ssl_verify_peer
    def start_tls args={}
      priv_key, cert_chain, verify_peer, sni_hostname = args.values_at(:private_key_file, :cert_chain_file, :verify_peer, :sni_hostname)
      ...
      EventMachine::set_tls_parms(@signature, priv_key || '', cert_chain || '', verify_peer, sni_hostname || '')
