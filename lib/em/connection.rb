module EventMachine
  ...
  class Connection
    ...
    # @see #ssl_verify_peer
    def start_tls args={}
      priv_key, cert_chain, cert_auth, verify_peer = args.values_at(:private_key_file, :cert_chain_file, :cert_auth_file, :verify_peer)

      [priv_key, cert_chain, cert_auth].each do |file|
