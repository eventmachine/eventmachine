em_lib_dir = ::File.join(::Dir.pwd, "em/")

require em_lib_dir + 'version'
require em_lib_dir + 'pool'
require em_lib_dir + 'deferrable'
require em_lib_dir + 'future'
require em_lib_dir + 'streamer'
require em_lib_dir + 'spawnable'
require em_lib_dir + 'processes'
require em_lib_dir + 'iterator'
require em_lib_dir + 'buftok'
require em_lib_dir + 'timers'
require em_lib_dir + 'protocols'
require em_lib_dir + 'connection'
require em_lib_dir + 'callback'
require em_lib_dir + 'queue'
require em_lib_dir + 'channel'
require em_lib_dir + 'file_watch'
require em_lib_dir + 'process_watch'
require em_lib_dir + 'tick_loop'
require em_lib_dir + 'resolver'
require em_lib_dir + 'completion'
require em_lib_dir + 'threaded_resource'
