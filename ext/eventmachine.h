...
extern "C" {
	...
	void evma_set_tls_parms (const unsigned long binding, const char *privatekey_filename, const char *certchain_filenane, const char *dhparams_filename, int verify_peer);
