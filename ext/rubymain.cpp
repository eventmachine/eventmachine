...
static VALUE t_set_tls_parms (VALUE self, VALUE signature, VALUE privkeyfile, VALUE certchainfile, VALUE dhparamsfile, VALUE verify_peer)
{
	 ...
	 */
	evma_set_tls_parms (NUM2ULONG (signature), StringValuePtr (privkeyfile), StringValuePtr (certchainfile), StringValuePtr (dhparamsfile), (verify_peer == Qtrue ? 1 : 0));
	return Qnil;
}
