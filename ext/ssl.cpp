...
SslBox_t::SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, bool verify_peer, SslMinVersion min_version, const uintptr_t binding):
	bIsServer (is_server),
