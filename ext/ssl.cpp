...
SslBox_t::SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, bool verify_peer, const string &cipherlist, int protocols, const uintptr_t binding):
	bIsServer (is_server),
