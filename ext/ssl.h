...
{
	public:
		SslContext_t (bool is_server, const string &privkeyfile, const string &certchainfile, SslMinVersion min_version);
...
{
	public:
		SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, bool verify_peer, SslMinVersion min_version, const unsigned long binding);
		virtual ~SslBox_t();
