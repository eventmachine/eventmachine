...
{
	public:
		SslContext_t (bool is_server, const string &privkeyfile, const string &certchainfile, const string &certauthfile);
...
{
	public:
		SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, const string &certauthfile, bool verify_peer, const unsigned long binding);
		virtual ~SslBox_t();
