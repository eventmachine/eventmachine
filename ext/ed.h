...
class EventableDescriptor: public Bindable_t
{
	public:
		...
		virtual void SetTlsParms (const char *privkey_filename, const char *certchain_filename, const char *cacert_filename, const char *ca_path, bool verify_peer) {}
...
class ConnectionDescriptor: public EventableDescriptor
{
	public:
		...
		virtual bool VerifySslPeer(const char*, int err, int depth);
