...
class EventableDescriptor: public Bindable_t
{
	public:
		...
		virtual void SetTlsParms (const char *privkey_filename, const char *certchain_filename, const char *certauth_filename, bool verify_peer) {}
...
class ConnectionDescriptor: public EventableDescriptor
{
	public:
		...
		virtual bool VerifySslPeer(bool, const char*);
