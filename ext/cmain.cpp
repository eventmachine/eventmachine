...
extern "C" int evma_get_peername (const unsigned long binding, struct sockaddr_storage *sa)
{
...
extern "C" int evma_get_sockname (const unsigned long binding, struct sockaddr_storage *sa)
{
